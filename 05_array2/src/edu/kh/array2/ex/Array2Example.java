...
public class Array2Example {
	...
	public void ex1() {
		...
		*/
		...
		// arr[0].length : arr[1]이 참조하고 있는 배열의 길이
	...
	public void ex3() {
		// 가변 배열
		// - 2차원 배열 생성 시 마지막 배열차수(열)를 지정하지 않고
		...
		arr[1] = new char[4]; // 1행에 4열자리 1차원 배열을 생성하여 주소값 저장
		arr[2] = new char[5]; // 2행에 5열자리 1차원 배열을 생성하여 주소값 저장
		arr[3] = new char[2]; // 3행에 2열자리 1차원 배열을 생성하여 주소값 저장

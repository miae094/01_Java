...
//		System.out.println(std.v4);
		...
		// Student 클래스를 ClsServic가 상속받았으므로
...
//		System.out.println(v4);		// 해당클래스 내부가 아닌 다른클래스 X
	...
	public void ex2() {
		 ...
		 * -> 프로그램 시작 시 static 이 붙은 코드들이 모두 static영역에 생성되고
	...
	public void ex3() {
		...
		// 객체가 생성될 때 부터 다른값으로 필드 초기화
		
		User u3 = new User("test3", "password1234");
		// 입력하지 않은 다른 값은 JVM 기본 값으로 들어감
		// 매개변수 생성자
	...
	public void ex4() {
		...
		User u3 = new User("user03", "pass03", "김철수", 26, '남');

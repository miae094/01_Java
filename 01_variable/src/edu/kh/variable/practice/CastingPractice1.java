...
public class CastingPractice1 {
	...
	public static void main(String[] args) {
		...
		// 선생님 답안
		System.out.println("================== 선생님이랑 같이 ====================");
		System.out.println( iNum1 / iNum2 ); // 2
		System.out.println( (int)dNum ); // 2
		System.out.println( iNum2 * dNum ); // 10.0 자동 형변환 int -> double
		...
		// float : 소숫점 아래 8번째 자리까지 연산 후 반올림
		// floatdms 23비트까지만 저장할 수 있어서
		...
		// double은 52비트까지 저장할 수 있어서 더 많은 자리수를
		// 정확피 표현할 수 있다. : 정밀도가 높아 마지막 값이 5
		// double 비트 수 : 64비트
